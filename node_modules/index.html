...
<script src="zdog-demo.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/zdog/2.9.1/zdog.min.js"></script>
</head>
<body>
  <div class="container">
    <canvas class="illo"></canvas>
    <p><a href="https://medium.com/@manjulcr7">@manjulcr7 MEDIUM</a></p>
